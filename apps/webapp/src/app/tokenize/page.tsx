                      ...
                      <>
                                ...
                                <div className="flex items-start gap-3">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-xs text-neutral-500 mt-1">
                                      Your property will be valued using
                                      Chainlink price feeds for accurate,
                                ...
                                <div className="flex items-start gap-3">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-xs text-neutral-500 mt-1">
                                      ...
                                      your property documents and verify
                                      ownership. This typically takes 3-5
                                      business days.
                                    </p>
                                  </div>
                                </div>
                        ...
                        <div className="flex items-center justify-between mt-8 pt-6 border-t border-[#262626]">
                          <Button
                            ...
                            onClick={prevStep}
                            disabled={
                              currentStep === 0 || formState.isSubmitting
                            }
