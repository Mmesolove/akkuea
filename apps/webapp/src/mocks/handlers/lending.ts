...
export const lendingHandlers = [
   ...
   */
  http.post(`${API_BASE}/lending/pools/:poolId/deposit`, async ({ request, params }) => {
   ...
   */
  http.post(`${API_BASE}/lending/pools/:poolId/borrow`, async ({ request, params }) => {
   ...
   */
  http.post(`${API_BASE}/lending/pools/:poolId/withdraw`, async ({ request, params }) => {
    const userAddr =
      request.headers.get("x-user-address") ||
      "GDEMOUSER1234567890AKKUEA00000000000000000000000000000000";
   ...
   */
  http.post(`${API_BASE}/lending/pools/:poolId/repay`, async ({ request, params }) => {
    const userAddr =
      request.headers.get("x-user-address") ||
      "GDEMOUSER1234567890AKKUEA00000000000000000000000000000000";
